...
<div id="content" class="two-column container">
<div class="catbox">
...
<div id="cart">
<div class="upbutton t-left mb1"><?php _e('Press the `update` button when you change the amount of items.','usces'); ?><input class="ml1" name="upButton" type="submit" value="<?php _e('Quantity renewal','usces'); ?>" onclick="return uscesCart.upCart()" /></div>

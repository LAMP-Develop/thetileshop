	...
	<div class="post" id="wc_<?php usces_page_name(); ?>">
		...
		<div class="entry">
			...
			<?php $entry_order_note = empty($usces_entries['order']['note']) ? apply_filters('usces_filter_default_order_note', NULL) : $usces_entries['order']['note']; ?>
				...
				<input name="backCustomer" type="button" class="back_to_customer_button" value="<?php _e('Back', 'usces'); ?>" onClick="history.back()" <?php echo apply_filters('usces_filter_deliveryinfo_prebutton', NULL); ?> />

...
<ul>
<li data-filter="kind" data-kind="0" class="js-filter-item active"><a href="<?php echo $home; ?>/category">タイルすべて</a></li>
<li data-filter="kind" data-kind="1" class="js-filter-item"><a href="<?php echo $all; ?>/sheet">シート</a></li>
<li data-filter="kind" data-kind="2" class="js-filter-item"><a href="<?php echo $all; ?>/piece">ピース</a></li>
<li data-filter="kind" data-kind="3" class="js-filter-item"><a href="<?php echo $all; ?>/set">セット</a></li>
</ul>
</section>
...
<li id="shape" class="js-sort-item active">形状で選ぶ</li>

<li id="color" class="js-sort-item">カラーで選ぶ</li>

<!-- #SHAPE -->
<div class="side_list_wrap" id="list_shape">
<ul class="side_list type01 clearfix">
<li><p><a href="<?php echo $all; ?>?tag=square" class="tooltip" title="正方形"><span class="icon"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_square.png" alt="正方形" width="28" height="10"></span><span class="menu_text">正方形</span></a></p></li>
<li><p><a href="<?php echo $all; ?>?tag=rectangle" class="tooltip" title="長方形"><span class="icon"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_rectangle.png" alt="長方形" width="28" height="10"></span><span class="menu_text">長方形</span></a></p></li>
<li><p><a href="<?php echo $all; ?>?tag=circular" class="tooltip" title="丸型"><span class="icon"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_circular.png" alt="丸型" width="28" height="10"></span><span class="menu_text">丸型</span></a></p></li>
<li><p><a href="<?php echo $all; ?>?tag=polygon" class="tooltip" title="多角形"><span class="icon"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_polygon.png" alt="多角形" width="28" height="10"></span><span class="menu_text">多角形</span></a></p></li>
<li><p><a href="<?php echo $all; ?>?tag=3dimension" class="tooltip" title="立体型"><span class="icon"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_3dimension.png" alt="立体型" width="28" height="10"></span><span class="menu_text">立体型</span></a></p></li>
<li><p><a href="<?php echo $all; ?>?tag=others" class="tooltip" title="その他"><span class="icon"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_shape_others.png" alt="その他" width="28" height="10"></span><span class="menu_text">その他</span></a></p></li>
</ul>
</div>
<!-- #COLOR -->
<div class="side_list_wrap none" id="list-color">
<ul class="clearfix">
<li><div class="colors_wrap"><p><a class="pie tooltip" style="border: 1px solid #e7e7e7; background: #ffffff;" href="<?php echo $all; ?>?tag=white" title="ホワイト系">ホワイト系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #000000;" href="<?php echo $all; ?>?tag=black" title="ブラック系">ブラック系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #808080;" href="<?php echo $all; ?>?tag=gray" title="グレー系">グレー系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #ff6666;" href="<?php echo $all; ?>?tag=pink" title="ピンク系">ピンク系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #e60012;" href="<?php echo $all; ?>?tag=red" title="レッド系">レッド系</a></p></div></li><li>
<div class="colors_wrap"><p><a class="pie tooltip" style=" background: #ff9900;" href="<?php echo $all; ?>?tag=orange" title="オレンジ系">オレンジ系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #660000;" href="<?php echo $all; ?>?tag=brown" title="ブラウン系">ブラウン系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #663399;" href="<?php echo $all; ?>?tag=perpule" title="パープル系">パープル系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #fff157;" href="<?php echo $all; ?>?tag=yellow" title="イエロー系">イエロー系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #339900;" href="<?php echo $all; ?>?tag=green" title="グリーン系">グリーン系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #0066cc;" href="<?php echo $all; ?>?tag=blue" title="ブルー系">ブルー系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style=" background: #d1c0a5;" href="<?php echo $all; ?>?tag=beige" title="ベージュ系">ベージュ系</a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style="background: none;" href="<?php echo $all; ?>?tag=yohen" title="窯変"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_yohen.png" alt="窯変" width="18" height="18" /></a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style="background: none;" href="<?php echo $all; ?>?tag=metallic" title="メタリック系"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_metallic.png" alt="メタリック系" width="18" height="18" /></a></p></div></li>
<li><div class="colors_wrap"><p><a class="pie tooltip" style="background: none;" href="<?php echo $all; ?>?tag=mix" title="ミックス"><img src="<?php bloginfo('stylesheet_directory'); ?>/asset/img/category/icon_mix.png" alt="ミックス" width="18" height="18" /></a></p></div></li>
</ul>
</div>
